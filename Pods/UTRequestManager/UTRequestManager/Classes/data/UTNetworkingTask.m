...
@implementation UTNetworkingTask {
...
+ (id)sharedInstance {
    static UTNetworkingTask * helper;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        helper = [[UTNetworkingTask alloc] init];
    });
    return helper;
}

+ (NSURLSessionDataTask *)dataTask:(UTRequestParam *)param success:(void (^)(id))success failure:(void (^)(NSError *))failure {
    UTNetworkingTask *helper = [UTNetworkingTask sharedInstance];
...
+ (NSURLSessionDownloadTask *)downloadTask:(UTRequestParam *)param
...
- (NSURLSessionDownloadTask *)p_downloadTask:(UTRequestParam *)param progress:(void (^)(NSProgress *))progress completionHandler:(void (^)(NSURL *, NSError *))completionHandler {
...
+ (NSURLSessionDataTask *)uploadTask:(UTRequestParam *)param
                               progress:(void(^)(NSProgress *progress))progress
...
- (NSURLSessionDataTask *)p_uploadTask:(UTRequestParam *)param
                               progress:(void(^)(NSProgress *progress))progress
                      completionHandler:(void (^)(id responseObject, NSError *error))completionHandler{
